    ...
    <div style={{ background: COLORS.cream, fontFamily: "'Helvetica Neue', Arial, sans-serif" }} className="pt-20">
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12 py-12 md:py-16">
          <FadeIn>
            ...
            <h1 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(2rem, 5vw, 2.75rem)', fontWeight: 800, color: COLORS.ink, marginBottom: 12, lineHeight: 1.2 }}>
              {t('fest_h1_part1')}<br /><span style={{ color: COLORS.saffron }}>{t('fest_h1_part2')}</span>
            </h1>
            <p style={{ color: COLORS.stone, fontSize: 17, lineHeight: 1.7, maxWidth: 600, marginTop: 8 }}>{t('fest_tagline')}</p>
            <div className="flex flex-wrap gap-3 mt-6">
              <a href="#submit-film" style={{ background: COLORS.saffron, color: '#fff', fontWeight: 600, padding: '10px 24px', borderRadius: 6, fontSize: 14, textDecoration: 'none' }} className="transition-opacity hover:opacity-90">{t('fest_submit_film')}</a>
              <a href="#about-festival" style={{ border: `2px solid ${COLORS.ink}`, color: COLORS.ink, fontWeight: 600, padding: '10px 24px', borderRadius: 6, fontSize: 14, textDecoration: 'none' }} className="transition-opacity hover:opacity-90">{t('fest_learn_more')}</a>
            </div>
          </FadeIn>
        </div>
      </section>
      ...
      <section style={{ background: COLORS.ink, padding: '64px 0' }}>
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px rounded-xl overflow-hidden" style={{ background: COLORS.stoneLight }}>
            {[{ number: '20+', label: t('fest_stat_years') }, { number: '1000+', label: t('fest_stat_screened') }, { number: '15+', label: t('fest_stat_countries') }, { number: '50K+', label: t('fest_stat_viewers') }].map((s, i) => (
      ...
      <section id="about-festival" style={{ background: COLORS.cream, padding: '96px 0' }}>
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <FadeIn>
            <Label>{t('fest_about_label')}</Label>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, color: COLORS.ink, marginBottom: 8 }}>{t('fest_about_heading')}</h2>
            <Divider />
          </FadeIn>
          <FadeIn delay={0.1}>
            <div style={{ background: '#fff', borderRadius: 16, padding: '40px 36px', marginBottom: 24, boxShadow: '0 4px 24px rgba(26,18,8,0.07)' }}>
              <p style={{ color: COLORS.stone, fontSize: 17, lineHeight: 1.9, marginBottom: 20 }}>{t('fest_about_p1')}</p>
              <p style={{ color: COLORS.stone, fontSize: 17, lineHeight: 1.9, marginBottom: 20 }}>{t('fest_about_p2')}</p>
              <p style={{ color: COLORS.stone, fontSize: 17, lineHeight: 1.9 }}>{t('fest_about_p3')}</p>
            </div>
          </FadeIn>
          <FadeIn delay={0.2}>
            <div style={{ background: '#fff', borderRadius: 16, padding: '36px', borderLeft: `5px solid ${COLORS.saffron}`, display: 'flex', alignItems: 'flex-start', gap: 20, boxShadow: '0 4px 24px rgba(26,18,8,0.07)' }}>
              ...
              <div>
                <h3 style={{ fontFamily: 'Georgia, serif', fontSize: 20, fontWeight: 800, color: COLORS.ink, marginBottom: 10 }}>{t('fest_bamboo_heading')}</h3>
                <p style={{ color: COLORS.stone, fontSize: 15, lineHeight: 1.8 }}>{t('fest_bamboo_body')}</p>
              </div>
            </div>
          </FadeIn>
        </div>
      ...
      <section style={{ background: '#fff', padding: '96px 0' }}>
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <FadeIn className="text-center mb-16">
            <Label>{t('fest_obj_label')}</Label>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, color: COLORS.ink, marginBottom: 16 }}>{t('fest_obj_heading')}</h2>
            <p style={{ color: COLORS.stone, fontSize: 16, maxWidth: 480, margin: '0 auto' }}>{t('fest_obj_sub')}</p>
          </FadeIn>
            ...
            {objectives.map((obj, i) => (
              <FadeIn key={obj.title} delay={i * 0.1}>
                <motion.div whileHover={{ y: -5, boxShadow: '0 12px 40px rgba(26,18,8,0.1)' }} transition={{ duration: 0.3 }} style={{ background: COLORS.cream, borderRadius: 14, padding: '32px 28px', borderLeft: `5px solid ${COLORS.saffron}`, boxShadow: '0 2px 12px rgba(26,18,8,0.05)', height: '100%' }}>
                  ...
                  <h3 style={{ fontFamily: 'Georgia, serif', fontSize: 18, fontWeight: 700, color: COLORS.ink, marginBottom: 10 }}>{t(`fest_obj_${i + 1}_title`)}</h3>
                  <p style={{ color: COLORS.stone, fontSize: 14, lineHeight: 1.8 }}>{t(`fest_obj_${i + 1}_description`)}</p>
                </motion.div>
              </FadeIn>
            ))}
          </div>
      ...
      <section style={{ background: COLORS.saffronMist, padding: '96px 0' }}>
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <FadeIn className="text-center mb-16">
            <Label>{t('fest_cat_label')}</Label>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, color: COLORS.ink, marginBottom: 16 }}>{t('fest_cat_heading')}</h2>
            <p style={{ color: COLORS.stone, fontSize: 16, maxWidth: 480, margin: '0 auto' }}>{t('fest_cat_sub')}</p>
          </FadeIn>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((cat, i) => (
              <FadeIn key={cat.title} delay={i * 0.1}>
                <motion.div whileHover={{ scale: 1.03 }} transition={{ duration: 0.25 }} style={{ background: i % 3 === 1 ? COLORS.ink : '#fff', borderRadius: 14, padding: '32px 28px', boxShadow: '0 2px 12px rgba(26,18,8,0.06)', minHeight: 200 }}>
                  ...
                  <h3 style={{ fontFamily: 'Georgia, serif', fontSize: 18, fontWeight: 700, color: i % 3 === 1 ? COLORS.saffron : COLORS.ink, marginBottom: 10 }}>{t(`fest_cat_${i + 1}_title`)}</h3>
                  <p style={{ color: i % 3 === 1 ? COLORS.stoneLight : COLORS.stone, fontSize: 14, lineHeight: 1.75 }}>{t(`fest_cat_${i + 1}_description`)}</p>
                </motion.div>
              </FadeIn>
            ))}
          </div>
      ...
      <section style={{ background: COLORS.ink, padding: '96px 0' }}>
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <FadeIn>
            <Label>{t('fest_awards_label')}</Label>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, color: '#fff', marginBottom: 16 }}>{t('fest_awards_heading')}</h2>
            <p style={{ color: COLORS.stoneLight, fontSize: 17, lineHeight: 1.8, marginBottom: 56, maxWidth: 580 }}>{t('fest_awards_sub')}</p>
          </FadeIn>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {awards.map((aw, i) => (
              <FadeIn key={aw.prize} delay={i * 0.1}>
                <motion.div whileHover={{ y: -6 }} transition={{ duration: 0.3 }} style={{ borderTop: `4px solid ${COLORS.saffron}`, background: COLORS.inkMid, borderRadius: 12, padding: '32px 28px', position: 'relative' }}>
                  {aw.featured && <div style={{ position: 'absolute', top: -1, right: 20, background: COLORS.saffronLight, color: COLORS.ink, fontSize: 11, fontWeight: 700, padding: '4px 12px', borderRadius: '0 0 8px 8px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>{t('fest_grand_prize')}</div>}
                  <div style={{ fontSize: 40, marginBottom: 12 }}>{aw.icon}</div>
                  <p style={{ color: COLORS.stoneLight, fontSize: 12, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.12em', marginBottom: 6 }}>{t(`fest_award_${i + 1}_prize`)}</p>
          ...
          <FadeIn delay={0.4}>
            <div style={{ marginTop: 48, padding: '32px 40px', background: 'rgba(255,255,255,0.06)', borderRadius: 16, borderLeft: `4px solid ${COLORS.saffron}` }}>
              <p style={{ color: '#fff', fontSize: 16, lineHeight: 1.8 }}>
                <strong style={{ color: COLORS.saffron }}>{t('fest_awards_note_strong')}</strong> {t('fest_awards_note')}
              </p>
            </div>
          </FadeIn>
        </div>
      ...
      <section style={{ background: '#fff', padding: '96px 0' }}>
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <FadeIn className="text-center mb-16">
            <Label>{t('fest_why_label')}</Label>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, color: COLORS.ink }}>{t('fest_why_heading')}</h2>
          </FadeIn>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <FadeIn key={item.reason} delay={i * 0.09}>
                <motion.div whileHover={{ y: -4 }} transition={{ duration: 0.25 }} style={{ background: COLORS.cream, borderRadius: 14, padding: '28px 24px', borderLeft: `5px solid ${COLORS.saffron}` }}>
                  <h3 style={{ fontFamily: 'Georgia, serif', fontSize: 18, fontWeight: 700, color: COLORS.ink, marginBottom: 10, display: 'flex', alignItems: 'center', gap: 8 }}>
                    <span style={{ color: COLORS.saffron, fontWeight: 900 }}>✓</span> {t(`fest_why_${i + 1}_reason`)}
                  </h3>
                  <p style={{ color: COLORS.stone, fontSize: 14, lineHeight: 1.8 }}>{t(`fest_why_${i + 1}_description`)}</p>
                </motion.div>
              </FadeIn>
            ))}
          </div>
      ...
      <section style={{ background: COLORS.saffronMist, padding: '96px 0' }}>
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <FadeIn className="text-center mb-16">
            <Label>{t('fest_jury_label')}</Label>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, color: COLORS.ink, marginBottom: 12 }}>{t('fest_jury_heading')}</h2>
            <p style={{ color: COLORS.stone, fontSize: 16 }}>{t('fest_jury_sub')}</p>
          </FadeIn>
            ...
            {juryMembers.map((m, i) => (
              <FadeIn key={m.name} delay={i * 0.1}>
                <motion.div whileHover={{ y: -6 }} transition={{ duration: 0.3 }} style={{ background: '#fff', borderRadius: 16, padding: '32px 20px', textAlign: 'center', boxShadow: '0 4px 20px rgba(26,18,8,0.08)', borderTop: `4px solid ${COLORS.saffron}` }}>
                  ...
                  <h3 style={{ fontFamily: 'Georgia, serif', fontWeight: 700, fontSize: 16, color: COLORS.ink, marginBottom: 4 }}>{t(`fest_jury_${i + 1}_name`)}</h3>
                  <p style={{ color: COLORS.stone, fontSize: 13, marginBottom: 8 }}>{t(`fest_jury_${i + 1}_role`)}</p>
                  <p style={{ color: COLORS.saffron, fontSize: 12, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em' }}>{t('fest_jury_year', { year: m.year })}</p>
                </motion.div>
              </FadeIn>
            ))}
          </div>
      ...
      <section style={{ background: COLORS.ink, padding: '96px 0' }}>
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <FadeIn>
            <Label>{t('fest_past_label')}</Label>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, color: '#fff', marginBottom: 12 }}>{t('fest_past_heading')}</h2>
            <p style={{ color: COLORS.stoneLight, fontSize: 17, marginBottom: 56 }}>{t('fest_past_sub')}</p>
          </FadeIn>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {pastFestivals.map((f, i) => (
              <FadeIn key={f.year} delay={i * 0.1}>
                <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.3 }} style={{ background: COLORS.inkMid, borderRadius: 16, padding: '32px 28px', borderTop: `4px solid ${COLORS.saffron}` }}>
                  ...
                  {[[t('fest_past_entries'), f.entries], [t('fest_past_screened'), f.screened], [t('fest_past_countries'), f.countries]].map(([label, val], idx) => (
          ...
          <FadeIn delay={0.4}>
            <div style={{ marginTop: 40, textAlign: 'center' }}>
              <Link to="/festival/previous" style={{ color: COLORS.saffron, fontWeight: 700, fontSize: 15, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
                {t('fest_past_view_all')} <span>→</span>
              </Link>
            </div>
          </FadeIn>
        </div>
      ...
      <section id="submit-film" style={{ background: COLORS.cream, padding: '96px 0' }}>
        <div className="max-w-3xl mx-auto px-6 md:px-12">
          <FadeIn>
            <Label>{t('fest_submit_label')}</Label>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.8rem, 4vw, 2.4rem)', fontWeight: 800, color: COLORS.ink, marginBottom: 8 }}>{t('fest_submit_heading')}</h2>
            <Divider />
            <p style={{ color: COLORS.stone, fontSize: 16, marginBottom: 48 }}>{t('fest_submit_sub')}</p>
          </FadeIn>
          <FadeIn delay={0.1}>
            <div style={{ background: '#fff', borderRadius: 20, padding: '48px 44px', boxShadow: '0 8px 40px rgba(26,18,8,0.10)', marginBottom: 32 }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
                {submissionSteps.map((step, i) => (
                  <div key={step.n} style={{ display: 'flex', alignItems: 'flex-start', gap: 20 }}>
                    ...
                    <div>
                      <h3 style={{ fontFamily: 'Georgia, serif', fontSize: 19, fontWeight: 700, color: COLORS.ink, marginBottom: 8 }}>{t(`fest_submit_step_${i + 1}_title`)}</h3>
                      <p style={{ color: COLORS.stone, fontSize: 15, lineHeight: 1.75, marginBottom: step.bullets ? 10 : 0 }}>{t(`fest_submit_step_${i + 1}_body`)}</p>
                      {step.bullets && (
                        <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: 4 }}>
                          {step.bullets.map((b, idx) => (<li key={b} style={{ color: COLORS.stone, fontSize: 13, display: 'flex', gap: 8 }}><span style={{ color: COLORS.saffron }}>•</span>{t(`fest_submit_step_${i + 1}_bullet_${idx + 1}`)}</li>))}
                        </ul>
                      )}
                      {step.note && <p style={{ color: COLORS.stoneLight, fontSize: 13, marginTop: 6 }}>{t(`fest_submit_step_${i + 1}_note`)}</p>}
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div style={{ marginTop: 40, paddingTop: 32, borderTop: `2px solid ${COLORS.saffronMist}` }}>
                <h4 style={{ fontFamily: 'Georgia, serif', fontWeight: 700, fontSize: 17, color: COLORS.ink, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
                  <span style={{ color: COLORS.saffron }}>📅</span> {t('fest_dates_heading')}
                </h4>
                <div className="grid md:grid-cols-2 gap-4">
                  {[[t('fest_date_deadline'), t('fest_date_deadline_val')], [t('fest_date_festival'), t('fest_date_festival_val')]].map(([title, val]) => (
          ...
          <FadeIn delay={0.2}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/festival/guidelines" style={{ background: COLORS.saffron, color: '#fff', fontWeight: 700, padding: '16px 32px', borderRadius: 8, textDecoration: 'none', fontSize: 15, textAlign: 'center', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 8 }} className="transition-opacity hover:opacity-90">
                {t('fest_view_guidelines')} <span>→</span>
              </Link>
              <Link to="/festival/submission-form" style={{ border: `2px solid ${COLORS.ink}`, color: COLORS.ink, fontWeight: 700, padding: '16px 32px', borderRadius: 8, textDecoration: 'none', fontSize: 15, textAlign: 'center' }} className="transition-opacity hover:opacity-90">
                {t('fest_start_submission')}
              </Link>
            </div>
            <p style={{ textAlign: 'center', color: COLORS.stone, fontSize: 14, marginTop: 24 }}>
              {t('fest_contact')} <a href="mailto:jeevika@ccs.in" style={{ color: COLORS.saffron, fontWeight: 600, textDecoration: 'none' }}>jeevika@ccs.in</a> or call <a href="tel:+911126537456" style={{ color: COLORS.saffron, fontWeight: 600, textDecoration: 'none' }}>+91-11-26537456</a>
            </p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <FadeIn direction="right">
              <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(1.8rem, 3.5vw, 2.6rem)', fontWeight: 800, color: '#fff', lineHeight: 1.2 }}>{t('fest_cta_heading')}</h2>
              <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: 16, marginTop: 12, maxWidth: 480 }}>{t('fest_cta_sub')}</p>
            </FadeIn>
            <FadeIn direction="left" delay={0.2}>
              <div style={{ display: 'flex', gap: 16, flexShrink: 0 }} className="flex-wrap">
                <a href="#submit-film" style={{ background: COLORS.ink, color: '#fff', fontWeight: 700, padding: '16px 32px', borderRadius: 8, textDecoration: 'none', fontSize: 15 }} className="transition-opacity hover:opacity-90">{t('fest_submit_film')}</a>
                <Link to="/contact" style={{ border: '2px solid #fff', color: '#fff', fontWeight: 700, padding: '16px 32px', borderRadius: 8, textDecoration: 'none', fontSize: 15 }} className="transition-opacity hover:opacity-90">{t('fest_cta_contact')}</Link>
              </div>
            </FadeIn>
          </div>
        </div>
